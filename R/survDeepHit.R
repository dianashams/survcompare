...
#' @param trained_model a trained model, output of survdhens_train()
...
#' @param max_grid_size number of random grid searches for model tuning
#' @param dftune_size size of the tuning data to define batch size options
#' @export
...
#' survdeephit_cv trains DeepHit model
